                        ...
                        <div class="panel panel-blue panel-widget">
                            <div class="row no-padding">
                                    ...
                                    <div class="col-sm-9 col-lg-7 widget-right">
                                            <div class="large">-</div>
                                            <div class="text-muted"><a href="{{ URL::to('createSchedule') }}" class="">Create Schedules</a></div>
                                    </div>
                            </div>
                        </div>
                    </div>
                     ...
                     <div class="col-sm-3"style="">
                        <div class="panel panel-orange panel-widget">
                            <div class="row no-padding">
                                    ...
                                    <div class="col-sm-9 col-lg-7 widget-right">
                                            <div class="large">-</div>
                                            <div class="text-muted"><a href="{{ URL::to('manageSchedule') }}" class="">Manage Schedules</a></div>
                                    </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-3"style="">
                        <div class="panel panel-red panel-widget">
                            <div class="row no-padding">
                                    ...
                                    <div class="col-sm-9 col-lg-7 widget-right">
                                            <div class="large">-</div>
                                            <div class="text-muted"><a href="{{ URL::to('deleteSchedules') }}" class="">Delete Schedules</a></div>
                                    </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-xs-12 col-md-6 col-lg-3">
                        <div class="panel panel-teal panel-widget">
                            <div class="row no-padding">
                                ...
                                <div class="col-sm-9 col-lg-7 widget-right">
                                        <div class="large">-</div>
                                        <div class="text-muted"><a href="{{ URL::to('lecturerSchedules') }}" class="">Lecturer Schedule</a></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-3"style="">
                        <div class="panel panel-teal panel-widget">
                            <div class="row no-padding">
                                ...
                                <div class="col-sm-9 col-lg-7 widget-right">
                                        <div class="large">-</div>
                                        <div class="text-muted"><a href="{{ URL::to('studentSchedules') }}" class="">Student Schedules</a></div>
                                </div>
                            </div>
                        </div>
                    </div>
