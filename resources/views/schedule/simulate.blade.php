...
<div class="container">
    <div class="table table-striped">
        <table class="table table-bordered" style="background: url('images/ttglogo1.jpg') center">
            ...
            <form class="form-group" method="POST" action="{{ URL::to('facSchedule/'.$scheduleId)}}">
                <div class="form-group">
                    <input type="hidden" name="_token" value="{{csrf_token()}}" />
                    <label>View Schedule by Faculty</label>
            ...
            <a href="{{URL::to('scheduleReport/'.$scheduleId)}}" target="_blank"><button  style="margin-right: 5%;background-color: #0099ff;color: white"class="btn pull-right">Schedule Report</button></a>
                <a href="{{URL::to('lecturerSchedules')}}"><button  style="margin-right: 1%;background-color: #6699ff;color: white"class="btn pull-right">View Schedule by Lecturers!</button></a>
            <tr>
                <th>Days</th>
                <th>7:00-9:00</th>
                <th>9:00-11:00</th>
            ...
            <tr>
                ...
                <td>@if(!empty($schedules[0]))
                    ...
                    -<b style="color: #3366ff">{{Course::find($schedule->course_id)->course_code}}</b> &nbsp; {{Hall::find($schedule->hall_id)->hall_name}} &nbsp;| @foreach(Course::getCourseLecturers($schedule->course_id) as $lec) <b style="color: #cc0000">{{App\Lecturer::getLecturerName($lec)}}</b> @endforeach<br/>
                    @endforeach
                @endif</td>
