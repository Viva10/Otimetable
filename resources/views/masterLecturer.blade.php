                         ...
                         <ul class="children collapse" id="student-links">
                            <li>
                                    <a class="" href="{{url('addStudents')}}">
                                            <svg class="glyph stroked chevron-right"><use xlink:href="#stroked-chevron-right"></use></svg> Add Student Group
                                    </a>
                            </li>
                            <li>
				...
				<div class="panel panel-blue panel-widget">
                                    <div class="row no-padding">
                                            ...
                                            <div class="col-sm-9 col-lg-7 widget-right">
                                                    <div class="large">-</div>
                                                    <div class="text-muted"><a href="{{ URL::to('addLecturers') }}" class="">Add Lecturers</a></div>
                                            </div>
                                    </div>
				</div>
			</div>
			...
			<div class="col-xs-12 col-md-6 col-lg-3">
				<div class="panel panel-orange panel-widget">
					<div class="row no-padding">
						...
						<div class="col-sm-9 col-lg-7 widget-right">
							<div class="large">-</div>
							<div class="text-muted"><a href="{{ URL::to('lecturerSchedules') }}">Lecturer Schedules</a></div>
						</div>
					</div>
				</div>
			</div>
			<div class="col-xs-12 col-md-6 col-lg-3">
				<div class="panel panel-red panel-widget">
					<div class="row no-padding">
						...
						<div class="col-sm-9 col-lg-7 widget-right">
							<div class="large">-</div>
                                                        <div class="text-muted"><a href="{{ URL::to('deleteLecturers') }}">Delete Lecturers</a></div>
						</div>
					</div>
				</div>
			</div>
