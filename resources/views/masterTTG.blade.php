				...
				<div class="panel panel-blue panel-widget">
					<div class="row no-padding">
						...
						<div class="col-sm-9 col-lg-7 widget-right">
							<div class="large">{{$halls}}</div>
                                                        <div class="text-muted"><a href="halls" id="anchor">Lecture Halls</a></div>
						</div>
					</div>
				</div>
			</div>
			<div class="col-xs-12 col-md-6 col-lg-3">
				<div class="panel panel-orange panel-widget">
					<div class="row no-padding">
						...
						<div class="col-sm-9 col-lg-7 widget-right">
							<div class="large">{{$schedulesS}}</div>
                                                        <div class="text-muted"><a href="schedules">Schedules</a></div>
						</div>
					</div>
				</div>
			</div>
			<div class="col-xs-12 col-md-6 col-lg-3">
				<div class="panel panel-teal panel-widget">
					<div class="row no-padding">
						...
						<div class="col-sm-9 col-lg-7 widget-right">
							<div class="large">{{$lecturers}}</div>
                                                        <div class="text-muted"><a href="lecturers">Lecturers</a></div>
						</div>
					</div>
				</div>
			</div>
			<div class="col-xs-12 col-md-6 col-lg-3">
				<div class="panel panel-red panel-widget">
					<div class="row no-padding">
						...
						<div class="col-sm-9 col-lg-7 widget-right">
							<div class="large">{{$courses}}</div>
                                                        <div class="text-muted"><a href="courses">Courses</a></div>
						</div>
					</div>
				</div>
			</div>
                                ...
                                <div class="panel panel-blue panel-widget">
                                    <div class="row no-padding">
                                            ...
                                            <div class="col-sm-9 col-lg-7 widget-right">
                                                    ...
                                                    <div class="text-muted"><a href="{{ URL::to('students') }}" class="">Students</a></div>
                                            </div>
                                    </div>
                                </div>
                            </div>
                             <div class="col-sm-3"style="">
                                <div class="panel panel-teal panel-widget">
                                    <div class="row no-padding">
                                            ...
                                            <div class="col-sm-9 col-lg-7 widget-right">
                                                    <div class="large">{{$periods}}</div>
                                                    <div class="text-muted"><a href="{{ URL::to('dayPeriods') }}" class="">Days & Periods</a></div>
                                            </div>
                                    </div>
                                </div>
                            </div>
