				...
				<div class="panel panel-blue panel-widget">
                                    <div class="row no-padding">
                                            ...
                                            <div class="col-sm-9 col-lg-7 widget-right">
                                                    <div class="large">-</div>
                                                    <div class="text-muted"><a href="{{ URL::to('courseNoLecturer') }}" class="">Courses without Lecturer</a></div>
                                            </div>
                                    </div>
				</div>
			</div>
    ...
    <div class="col-sm-3">
				<div class="panel panel-teal panel-widget">
                                    <div class="row no-padding">
                                            ...
                                            <div class="col-sm-9 col-lg-7 widget-right">
                                                    <div class="large">-</div>
                                                    <div class="text-muted"><a href="{{ URL::to('courseWithLecturer') }}" class="">Courses with Lecturer</a></div>
                                            </div>
                                    </div>
				</div>
			</div>
