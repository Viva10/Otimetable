...
@section('header')
    Manage Courses Without Students
@endsection
@section('link')
<div class="row">
...
<svg class="glyph stroked arrow-left"><use xlink:href="#stroked-arrow-left"></use></svg>                                            </div>
                                            <div class="col-sm-9 col-lg-7 widget-right">
                                                    <div class="large">-</div>
                                                    <div class="text-muted"><a href="{{ URL::to('courseStudents') }}" class=""> < Go Back</a></div>
                                            </div>
                                    </div>
				</div>
			</div>
...
@section('content')
<div class="row">
    <div class="panel-heading" style="color: #C20000">Table of Courses Without Students</div>
...
<!-- Controlling the color of the row if the hall is included to the scheduler or excluded-->
                @foreach($courses as $course)
                    ...
                    <tr style="background-color: @if($course->availability == 0) #eeeeee @endif">
                        ...
                        <td><a href="{{ URL::to('assignCourseStudent/'.$course->id) }}"><button type = "button" class="btn btn-primary btn-sm"><span class="glyphicon glyphicon-pencil" style="color:color"></span> Assign Student</button></a> </td>
                   </tr>
