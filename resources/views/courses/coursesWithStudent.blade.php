...
@section('content')
<div class="row">
    <div class="panel-heading" style="color: #C20000">Table of Courses With Students</div>
...
<!-- Controlling the color of the row if the hall is included to the scheduler or excluded-->
                @foreach($courses as $course)
                    ...
                    <tr style="background-color: @if($course->availability == 0) #eeeeee @endif">
                        ...
                        <td><a href="{{ URL::to('assignCourseStudent/'.$course->id) }}"><button type = "button" class="btn btn-primary btn-sm"><span class="glyphicon glyphicon-pencil" style="color:color"></span> Assign More...</button></a> </td>
